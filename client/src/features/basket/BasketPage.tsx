...
<>
        ...
        <TableRow
            ...
            >
              ...
              <TableCell align="right">{item.price.toFixed(2)} BAM</TableCell>
              <TableCell align="center">
                ...
                onClick={() => dispatch(addBasketItemAsync({productId: item.productId}))} color='error'>
                     <Add />
                </LoadingButton>
                </TableCell>
              <TableCell align="right">{(item.price * item.quantity).toFixed(2)} BAM</TableCell>
